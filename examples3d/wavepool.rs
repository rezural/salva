...
pub fn init_world(testbed: &mut Testbed) {
    ...
    // Liquid.
    let nparticles = 50;
    let mut fluid: Fluid<f32> = helper::cube_fluid(nparticles, nparticles, nparticles, particle_rad, 3000.0);
...
// fn dump_sizes() {
//     let particle_radius: f32 = 0.1;
//     let particle_diam = particle_radius * 2;
